...
export const workProjects: WorkProject[] = [
  ...
  {
    id: 8,
    title: "The Glow Up — A Melrose District Salon",
    client: "The Glow Up",
    category: "Web",
    tags: ["Web", "SEO"],
    description:
      "A free modern rebuild for a Melrose District salon — hosted, managed, every change answered within 24 hours.",
    youtubeId: "nBTiySfg5gA",
    externalUrl: "https://www.youtube.com/watch?v=nBTiySfg5gA",
    challenge: "A Melrose District salon needed a modern, professional website without the cost of a typical build — and needed changes handled fast, not left sitting for weeks.",
    solution: "Delivered a free, fully modern website rebuild, then took over hosting and ongoing management — with every requested change answered within 24 hours.",
    deliverables: ["Free modern website rebuild", "Hosting & ongoing management", "24-hour change turnaround", "YouTube walkthrough"],
  },
  {
    id: 11,
...
export interface LibraryTrack {
  id: number;
  title: string;
  artist: "CLOVER" | "Aubrey Hightower" | "TrashCat";
  genres: string[];
  moods: string[];
  spotifyTrackId: string;
}
...
export const libraryTracks: LibraryTrack[] = [
  {
    id: 1,
    title: "Right Here All Along",
    artist: "CLOVER",
    genres: ["Country"],
    moods: ["Uplifting"],
    spotifyTrackId: "7mk8CIvn6MvcGvghbQXWUA",
  },
  {
    id: 2,
    title: "I Just Wanna",
    ...
    genres: ["Pop", "Dance"],
    moods: ["Chill"],
    spotifyTrackId: "6CDMPGUUeh39cRZ1ooLlfM",
  },
  {
    id: 3,
    title: "Boobs!",
    ...
    spotifyTrackId: "4t9dW0NHiZscCGC2fGEQOU",
  },
  {
    id: 4,
    title: "Mark My Words",
  ...
  {
    id: 5,
    title: "Nothing Else Moves Me",
    artist: "Aubrey Hightower",
    genres: ["Dance", "EDM"],
    moods: ["Chill", "Euphoric", "Uplifting"],
    spotifyTrackId: "56xa7UsH7mJwuytJU6IX6z",
  },
  {
    id: 6,
    title: "All My Shits & Fucks",
    artist: "TrashCat",
    genres: ["EDM", "Hip-hop"],
    moods: ["Energetic"],
    spotifyTrackId: "0WfOSiDxnX2ilZzEhgFut0",
  ...
  {
    id: 7,
    title: "I'm On the Brink",
    artist: "CLOVER",
    genres: ["Dance", "EDM", "Pop"],
    moods: ["Energetic", "Euphoric", "Cinematic"],
    spotifyTrackId: "7l3cqQPA8pHuKiOjZM1ahj",
  },
  {
    id: 8,
    title: "Dance of Shame",
    artist: "Aubrey Hightower",
    genres: ["Dance", "EDM", "Pop"],
  ...
  },
  {
    ...
    genres: ["Pop"],
    moods: ["Emotional"],
    spotifyTrackId: "6PLL5E5jPGV9dMaX0LrM8T",
  },
  {
    id: 11,
    title: "Stay With Me",
    ...
    genres: ["Dance", "EDM"],
    moods: ["Uplifting"],
    spotifyTrackId: "4tUUsdZYpwfwnlcVIrZLFo",
  },
  {
    id: 12,
    title: "PAC-MAN, PAC-MAN (Eating All the Dots Again)",
    artist: "TrashCat",
    genres: ["EDM", "Dubstep", "Hip-hop"],
    moods: ["Energetic", "Dark", "Hype"],
    spotifyTrackId: "5lRsEbXeMpaUFxr1pbaRJw",
  },
  {
    id: 13,
    title: "GridBreak",
    ...
    spotifyTrackId: "763fIVrOz25J8Hbk18309G",
  },
  {
    id: 14,
    title: "Outta My Mind",
    ...
    spotifyTrackId: "2baHzN3RQOZVCZHMA91Q08",
  },
  {
    id: 15,
    title: "Downtown Phonk Drift",
    artist: "TrashCat",
    genres: ["EDM", "Phonk"],
    moods: ["Cinematic", "Dark", "Hype"],
    spotifyTrackId: "0ITqPdVOn6ZGbVbGOsyTid",
  },
  {
    id: 16,
    title: "i hope you know — soft corruption",
    artist: "CLOVER",
    genres: ["Lofi", "Hip-hop"],
    moods: ["Uplifting", "Emotional", "Chill"],
    spotifyTrackId: "6eLORqWnJ7DdrDZuNciCrY",
  },
  {
    id: 17,
    title: "I Don't Beg",
    ...
    spotifyTrackId: "0undhdsBzZxUj6RWnaYoFT",
  },
  {
    id: 18,
    title: "Charlie Sheen",
    artist: "TrashCat",
    genres: ["EDM", "Dubstep"],
    moods: ["Energetic", "Cinematic", "Hype"],
    spotifyTrackId: "2WHMCVU78hcknoWJv7xwn2",
  },
  {
    id: 19,
    title: "Borrowed Heart. Borrowed Light",
    artist: "Aubrey Hightower",
    genres: ["Pop"],
    moods: ["Chill", "Emotional"],
    spotifyTrackId: "2qH8FqG5MXdRfo6B5bv2xU",
  },
  {
    id: 20,
    title: "GEEK MODE",
    ...
    spotifyTrackId: "1hRre7bul36jdtUzPLgL1i",
  },
  {
    id: 21,
    title: "Downtown Phoenix Love",
    artist: "CLOVER",
    genres: ["Pop", "Jazz"],
    moods: ["Chill", "Cinematic", "Uplifting"],
    spotifyTrackId: "3mZp4B1sJTwONxW6CsAhIh",
  },
  {
    id: 22,
    title: "I Knew You'd Feel This",
    artist: "Aubrey Hightower",
    genres: ["Dance", "Pop"],
    moods: ["Chill", "Dark", "Emotional"],
    spotifyTrackId: "1V8RMtW0JOHyTW6Z1poHo8",
  },
  {
    id: 23,
    title: "I Dare a Bitch",
    artist: "TrashCat",
    genres: ["EDM", "Hip-hop"],
    moods: ["Energetic", "Hype"],
    spotifyTrackId: "63vXaZ0o3PC3N2kGFry6hn",
  },
  {
    id: 24,
    title: "i want a girl who reads",
    artist: "CLOVER",
    genres: ["Dance", "Pop", "EDM"],
    moods: ["Energetic", "Cinematic", "Uplifting"],
    spotifyTrackId: "3AX1XdI0NCAxaaGXsEFC9J",
  },
  {
    id: 25,
    title: "My Magic Time Machine",
    artist: "Aubrey Hightower",
    genres: ["Pop"],
    moods: ["Chill", "Uplifting", "Emotional"],
    spotifyTrackId: "6AGmCnTNI0T9GbhADMt7aX",
  },
  {
    id: 26,
    title: "Panicking Anakin",
    artist: "TrashCat",
    genres: ["Hip-hop", "EDM"],
    moods: ["Cinematic", "Dark", "Hype"],
    spotifyTrackId: "4aa2eOc1J2mHRgMt5l2Nsb",
  },
  {
    id: 27,
    title: "Unravel Me",
    ...
    spotifyTrackId: "3ahFAGsgtub9MzEboT9LdL",
  },
  {
    id: 28,
    ...
    genres: ["Dance", "Pop"],
    moods: ["Energetic", "Cinematic", "Uplifting"],
    spotifyTrackId: "6mgE5xZG2PFMhpo5IGsBhl",
  },
  {
    id: 29,
    title: "The Conundrummer",
    artist: "TrashCat",
    genres: ["EDM", "Bass House"],
    moods: ["Energetic", "Dark", "Hype"],
    spotifyTrackId: "1yY5I20WD8u4AHL2cihHej",
  },
];
