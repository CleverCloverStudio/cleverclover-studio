...
export default function ThankYouSongBrandPage() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-6 text-center">
        <AnimatedReveal>
          ...
          <h1 className="mt-4 font-display text-4xl font-bold text-cream md:text-5xl">
            Your brand song is on its way.
          </h1>
          <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-light">
            We're building the sound that defines your brand. Check your email for a
            confirmation — we'll reach out within 24 hours to align on voice, genre, and
            message.
          </p>
        </AnimatedReveal>
        ...
        <AnimatedReveal delay={0.1}>
          <div className="mt-10 rounded-2xl border border-white/8 bg-dark-200 p-8 text-left">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-light">
              Add a social media cut — a short-form video edit of your brand song, optimized
              for Instagram Reels, TikTok, and YouTube Shorts. Ready to post the day your
              song drops.
            </p>
            <a
              href="https://buy.stripe.com/eVqeV79Zf7As9FG2Hp9bO0e"
              target="_blank"
