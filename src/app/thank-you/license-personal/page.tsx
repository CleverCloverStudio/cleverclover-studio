...
export default function ThankYouLicensePersonalPage() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-6 text-center">
        <AnimatedReveal>
          ...
          <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-light">
            Your personal use license is active. Check your email for the confirmation and
            download link. You're clear to use this track in your personal project.
          </p>
        </AnimatedReveal>
        ...
        <AnimatedReveal delay={0.1}>
          <div className="mt-10 rounded-2xl border border-white/8 bg-dark-200 p-8 text-left">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-light">
              Exclusive rights mean no one else can license this track after you — it becomes
              yours alone. Lock it in now before someone else does, and use it for commercial
              projects with full ownership and protection.
            </p>
            <a
