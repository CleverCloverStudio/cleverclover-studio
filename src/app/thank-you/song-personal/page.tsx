...
export default function ThankYouSongPersonalPage() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-6 text-center">
        <AnimatedReveal>
          ...
          <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-light">
            Check your email for a confirmation. We'll reach out within 24 hours to get your
            story, pick your voice, and start writing.
          </p>
        </AnimatedReveal>
        ...
        <AnimatedReveal delay={0.1}>
          <div className="mt-10 rounded-2xl border border-white/8 bg-dark-200 p-8 text-left">
            ...
            <h2 className="mt-3 font-display text-2xl font-bold text-cream">
              Give your song a visual.
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-muted-light">
              A professionally produced lyric video brings your song to life — shareable on
              YouTube, Instagram, and TikTok the moment it's delivered. Add one now while
              your order is fresh.
            </p>
            <a
              href="https://buy.stripe.com/00w3cp0oFbQI8BC6XF9bO0c"
              target="_blank"
